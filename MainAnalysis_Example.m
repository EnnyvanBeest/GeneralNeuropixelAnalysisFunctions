%% User Input
DataDir = {'H:\Anna_TMP\RawData'};%{'\\znas\Subjects','\\128.40.198.18\Subjects','\\zaru.cortexlab.net\Subjects'}%'\\znas\Subjects' %' Check DataDir2Use
SaveDir = 'H:\Anna_TMP\Output_Enny\'
tmpdatafolder = 'H:\Anna_TMP\Output_Enny\'; % temporary folder for acute recordings - preferably SSD
ChronicTmpFolder = 'H:\Anna_TMP\Output_Enny\' %Temporary folder for chronic, needs to be big!
LocalDir = 'H:\Anna_TMP\KilosortOutput\';% 'E:\Data\KiloSortOutput';%
...
MatchUnitsAcrossDays = 0; % Matching chronic recording using QM instead of using pyks chronic output
